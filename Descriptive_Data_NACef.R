...
NACef_Data <- read_csv("~/Library/CloudStorage/OneDrive-UniversidaddelaSabana/Documentos/Working on/TsIDCCM/Physionet/NACef/Para Subir a Physionet/NACef_Data.csv")
NACef_2024 <- NACef_Data
